...
theorem axiom4_is_perp_line (L L₁ : Line) (P : Point) (hL : valid L) (hL₁ : valid L₁) :
  ...
  · -- Forward direction: Axiom 4 implies scaled perp_line
    ...
    · -- Prove L = scaled a (perp_line L₁ P)
      ...
      funext i
      fin_cases i
      · -- Force Lean to use the standard numeral '0' instead of the messy fin_cases artifact
        change L 0 = scaled a (perp_line L₁ P) 0
        -- Because we used rfl in h0, it matches the unfolded definition perfectly!
        exact h0
      · change L 1 = scaled a (perp_line L₁ P) 1
        exact h1
      · change L 2 = scaled a (perp_line L₁ P) 2
        exact h2
...
theorem axiom6_is_simultaneous_tangent (L L₁ L₂ : Line) (P₁ P₂ : Point) :
  Axiom6 P₁ P₂ L₁ L₂ L ↔ is_tangent_to_parabola L P₁ L₁ ∧ is_tangent_to_parabola L P₂ L₂ := by
...
theorem axiom6_characterization (L L₁ L₂ : Line) (P₁ P₂ : Point) (hL : valid L) :
  Axiom6 P₁ P₂ L₁ L₂ L ↔ places_onto_eq L L₁ P₁ ∧ places_onto_eq L L₂ P₂ := by
